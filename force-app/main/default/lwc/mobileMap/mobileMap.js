...
export default class MobileMaps extends LightningElement {
  ...
  renderedCallback() {
    console.log('markers----->',JSON.stringify(this.filteredMarkers),'-------end')
    if (!this.isMarkersListEqual()) {
      console.log('inside markers list view');
      console.log('filteredMarkers----->',JSON.stringify(this.filteredMarkers),'-------end')
      console.log('resourceMarker----->',JSON.stringify(this.resourceMarker),'-------end')
  ...
  onMarkerSelect(event) {
    ...
    try {
     ...
     // console.log('ind--------->',JSON.stringify(ind));
  ...
  get currentMarkerFirstDetailFieldValue() {
    console.log('subject',this.currentMarker?.value?.firstDetailFieldValue);
