...
export default class Fsm_simpleSketchPhotoCapture extends LightningElement {
  ...
  handleClick() {
    if (!!this.imageData && this.imageData.length != 3) {
      ...
      //   this.dispatchEvent(
      //     new CustomEvent("nextbtn", {
      //       detail:{data:datatofileuploadercmp,image:this.imageData,siteicon:this.siteicon,selbsemap:this.selbsemap,sketchimg:this.sketchimagesdata}
      ...
      //      detail:{data:datatofileuploadercmp,image:this.imageData,siteicon:this.siteicon,selbsemap:this.selbsemap,sketchimg:this.sketchimagesdata,imageeditor:this.imgsarreditor,shapes:this.shapearreditor,text:this.txtarreditor}
      //     })
      // );
      // }
      // else{
